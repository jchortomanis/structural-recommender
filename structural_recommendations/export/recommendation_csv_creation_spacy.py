...
print('len(all_entities), len(tfidf_recommendations_list):', len(all_entities), len(spacy_recommendations_list))
...
all_recommendations.to_csv('output/spacy_all_recommendations.csv')
